...
export default function TransitionsModal({ children, media_type, id }) {
  ...
  const fetchData = async () => {
    const { data } = await axios.get(
      `https://api.themoviedb.org/3/${media_type}/${id}?api_key=c72d30702ab3ffa8f3e95e24196b7ce5&language=en-US`
    );
  ...
  const fetchVideo = async () => {
    const { data } = await axios.get(
      `https://api.themoviedb.org/3/${media_type}/${id}/videos?api_key=c72d30702ab3ffa8f3e95e24196b7ce5&language=en-US`
    );
